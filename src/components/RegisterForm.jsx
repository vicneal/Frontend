...
export const RegisterForm = () => {
  ...
  const handleRegistro = async (e) => {
    ...
    try {
      ...
      if (data && data.token) {
        ...
        // console.error('El objeto "data" no contiene la propiedad "token".', data);
      }
    } catch (error) {
  ...
  return (
    <div className='w-[100%] h-[100%]'>
      <form onSubmit={handleRegistro} className=' border-[1px] border-slate-500 border-solid rounded-[20px] p-10 my-10 w-[400px] mx-auto flex-col'>
        <div>
          <img src={devLogo} className="w-[135px]" alt="Vite logo" />
        </div>
        <div>
          <h2 className='font-bold mt-4'>Join thousands of learners from around the world</h2>
          <p className='text-gray-700 text-sm my-2'>Master web development by making real-life projects. There are multiple paths for you to choose</p>
        </div>
        <div className='mb-2'>
        ...
        <div className="relative w-full min-w-[200px] h-10  mb-3">
          <input
            ...
            id="" />
          <label
            className="flex w-full h-full select-none pointer-events-none absolute left-0 font-semibold  peer-placeholder-shown:text-gray-500 leading-tight peer-focus:leading-tight peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all -top-1.5 peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px] before:content[' '] before:block before:box-border before:w-2.5 before:h-1.5 before:mt-[6.5px] before:mr-1 peer-placeholder-shown:before:border-transparent before:rounded-tl-md before:border-t peer-focus:before:border-t-2 before:border-l peer-focus:before:border-l-2 before:pointer-events-none before:transition-all peer-disabled:before:border-transparent after:content[' '] after:block after:flex-grow after:box-border after:w-2.5 after:h-1.5 after:mt-[6.5px] after:ml-1 peer-placeholder-shown:after:border-transparent after:rounded-tr-md after:border-t peer-focus:after:border-t-2 after:border-r peer-focus:after:border-r-2 after:pointer-events-none after:transition-all peer-disabled:after:border-transparent peer-placeholder-shown:leading-[3.75] text-blue-gray-400 peer-focus:text-blue-500 before:border-blue-gray-200 peer-focus:before:border-blue-500 after:border-blue-gray-200 peer-focus:after:border-blue-500">
            Email</label>
        </div>
        <div className='mb-2'>
        ...
        <div className="text-center my-3">
          <p className='text-gray-500 text-sm'>or continue with these social profile</p>
        </div>
        ...
        <div className="text-center mt-4 text-sm">
          <p className='text-gray-500'>Adready a member? <a href="/login" className='text-blue-600'>Login</a></p>
        </div>
      </form>
    </div>
